...
so it gives one unique API key to us : YourQuandlApiKey and whatever email address we had 
provided at the time of signing up would be your username and password would be password which
you had created at singing up an account on quandl.com
...
url = https://www.quandl.com/api/v3/datasets/CHRIS/MGEX_IH1.json?api_key=YourQuandlApiKey
...
# r = requests.get("https://www.quandl.com/api/v3/datasets/CHRIS/MGEX_IH1.json?api_key=YourQuandlApiKey")
# print(r.text)
